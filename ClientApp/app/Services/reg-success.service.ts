...
export class RegSuccessService {
  ...
  GetAllHeader(UserId,EntityId,Status): Observable<any> {
      return this._http.get<any>(this.baseUrl + 'api/MandateRegOutWord/GetAllHeader/' + UserId + '/' + EntityId + '/' + Status);
      
  }
  GetAllDetails(UserId,EntityId,Status,lotNo): Observable<any> {
    return this._http.get<any>(this.baseUrl + 'api/MandateRegOutWord/GetAllDetails/' + UserId + '/' + EntityId + '/' + Status + '/' + lotNo);
  }
