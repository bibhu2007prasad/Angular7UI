...
import { SubCorporateSetUpService } from 'ClientApp/app/Services/sub-corporate-set-up.service';
...
MainGideDiv = true;
EntityFormDiv = false;
MasterSubCorporateUpFormGroup: FormGroup;
...
_EntityId:any;
constructor(private formBuilder: FormBuilder, private ESService: SubCorporateSetUpService) {
    ...
    this.ESService.EditEntity(data.EntityId).subscribe(
        (data) => {
            ...
            if (data.Table.length>0)
            {
                ...
                this.MasterSubCorporateUpFormGroup.controls['IstxtMaxlenth'].setValue(Reflength);
                if(data.Table[i].ReflengthType=='M')
                {
                    this.MasterSubCorporateUpFormGroup.controls['IsrdoMaxLength'].setValue(true);
                }
                if(data.Table[i].ReflengthType=='F')
                {
                    this.MasterSubCorporateUpFormGroup.controls['IsrdoFixed'].setValue(true);
                }
                // if(IsRefrenceCheck==1)
                // {
                // // jquery_1_11_3_min_p("#DivAdminUserCount").css('display', 'block');
                //     this.MasterSubCorporateUpFormGroup.controls[BankValidationAdminCount].setValue(data.Table.BankValidationAdminCount);
        ...
        if(IsEmandate==1)
          {
            this.MasterSubCorporateUpFormGroup.controls['IsEMandate'].setValue(true);
           //jquery_1_11_3_min_p('#chkEmandate').prop('checked', true);
           }else  
           {
            //jquery_1_11_3_min_p('#chkEmandate').prop('checked', false);
            this.MasterSubCorporateUpFormGroup.controls['IsEMandate'].setValue(false);
           }

          var IsPhysical=data.Table[i].IsPhysical;
          if(IsPhysical==1)
          {
            this.MasterSubCorporateUpFormGroup.controls['IsPhysicalMandateCh'].setValue(true);
           //jquery_1_11_3_min_p('#chkPhysical').prop('checked', true);
           }else  
           {
            //jquery_1_11_3_min_p('#chkPhysical').prop('checked', false);
            this.MasterSubCorporateUpFormGroup.controls['IsPhysicalMandateCh'].setValue(false);
           }
...
//            }
       ...
       var Type=data.Table[i].DebitType;
        if(Type=='f')
        {
            this.MasterSubCorporateUpFormGroup.controls['FixedAmount_Ch'].setValue(true);
         //jquery_1_11_3_min_p('input:radio[name="rdoNomDebit"]').filter('[value="f"]').prop('checked', true);
         }else  if(Type=='m')
         {
            this.MasterSubCorporateUpFormGroup.controls['MaximumAmount_Ch'].setValue(true);
         ...
         if(Type=='m')
         {
            this.MasterSubCorporateUpFormGroup.controls['Monthly_Ch'].setValue(true);
          }else  if(Type=='q')
          {
           //jquery_1_11_3_min_p('input:radio[name="rdoNomFrequency"]').filter('[value="q"]').prop('checked', true);
           this.MasterSubCorporateUpFormGroup.controls['Quarterly_Ch'].setValue(true);
          }
          else  if(Type=='h')
          {
           //jquery_1_11_3_min_p('input:radio[name="rdoNomFrequency"]').filter('[value="h"]').prop('checked', true);
           this.MasterSubCorporateUpFormGroup.controls['Half_Yearly_Ch'].setValue(true);
           
          }
          else  if(Type=='y')
          {
           //jquery_1_11_3_min_p('input:radio[name="rdoNomFrequency"]').filter('[value="y"]').prop('checked', true);
           this.MasterSubCorporateUpFormGroup.controls['Yearly_Ch'].setValue(true);
          }
            else  if(Type=='a')
          {
          // jquery_1_11_3_min_p('input:radio[name="rdoNomFrequency"]').filter('[value="a"]').prop('checked', true);
          this.MasterSubCorporateUpFormGroup.controls['Presented_Ch'].setValue(true);
          }
        ...
        Type=data.Table[i].ToDebit;
          if(Type=='sb')
          {
            this.MasterSubCorporateUpFormGroup.controls['SB_Ch'].setValue(true);
...
//this.MasterSubCorporateUpFormGroup.controls['txtInstructingMenmerId'].setValue(data.Code);
        // jquery_1_11_3_min_p('#txtInstructingMenmerId').val(jsonData[i].InstructingMemberId)
        this.MasterSubCorporateUpFormGroup.controls['Code'].setValue(data.Table[i].Code);
         ...
         this.MasterSubCorporateUpFormGroup.controls['Name'].setValue(data.Table[i].ContactPerson);

         this.MasterSubCorporateUpFormGroup.controls['Code'].setValue(data.Table[i].Code);
         this.MasterSubCorporateUpFormGroup.controls['EntityName'].setValue(data.Table[i].Name);

         this.MasterSubCorporateUpFormGroup.controls['BankCode'].setValue(data.Table[i].SponsorBankCode);
         this.MasterSubCorporateUpFormGroup.controls['UtilityCode'].setValue(data.Table[i].UtilityCode);
         this.MasterSubCorporateUpFormGroup.controls['BankName'].setValue(data.Table[i].SponsorBankName);
        ...
        if(CheckerRequired==1)
                 {
                    ...
                    this.MasterSubCorporateUpFormGroup.controls['recheckthepresentmentfileCh'].setValue(true);
                 // jquery_1_11_3_min_p('#divRecheck').prop('checked', true);
                  ...
                  }else if(CheckerRequired==0) 
                  {
                    ...
                    this.MasterSubCorporateUpFormGroup.controls['recheckthepresentmentfileCh'].setValue(false);
                 ...
                 var CheckerRecheck=data.Table[i].CheckerRecheck;
                  if(CheckerRecheck==1)
                  {
                    ...
                    this.MasterSubCorporateUpFormGroup.controls['CheckerRequire'].setValue(true);
                ...
                this.MasterSubCorporateUpFormGroup.controls['CheckerRequire'].setValue(true);
                 ...
                 // kendo_all_min_js("#ddlCountry").data("kendoDropDownList").value(data.Table2.CountryId);
                  this.MasterSubCorporateUpFormGroup.controls['Country'].setValue(data.Table2[i].CountryId);
             this.CountryFunction(data.Table2[i].CountryId);
               //BindddlState();
                 //kendo_all_min_js("#ddlState").data("kendoDropDownList").value(jsonData[i].StateId);
                 this.MasterSubCorporateUpFormGroup.controls['State'].setValue(data.Table2[i].StateId);
                 this.StateFun(data.Table2[i].StateId);
               //  BindddlCity();
                // kendo_all_min_js("#ddlCity").data("kendoDropDownList").value(jsonData[i].CityId);

                this.MasterSubCorporateUpFormGroup.controls['City'].setValue(data.Table2[i].CityId); 
                this.MasterSubCorporateUpFormGroup.controls['Address'].setValue(data.Table2[i].Address);
                this.MasterSubCorporateUpFormGroup.controls['MobileNo'].setValue(data.Table2[i].Mobile);
                this.MasterSubCorporateUpFormGroup.controls['Email'].setValue(data.Table2[i].Email);
                this.MasterSubCorporateUpFormGroup.controls['PinCode'].setValue(data.Table2[i].Pincode);
            ...
            //    jquery_1_11_3_min_p('#lblFinalImage').html(jsonData[i].ImagePath);
                 ...
                 this.MasterSubCorporateUpFormGroup.controls['UserName'].setValue(data.Table3[i].UserName);
               ...
               for (var x = 0; x < data.Table5[i].length; x++) {
                //this.MasterSubCorporateUpFormGroup.controls['BillingUserName'].app
    ...
    if(data.Table7[0].isenable==true)
    {
        ...
        this.MasterSubCorporateUpFormGroup.controls['FixedAmount_Ch'].setValue(false);
    }
    if(data.Table7[1].isenable==true)
    {
        ...
        this.MasterSubCorporateUpFormGroup.controls['MaximumAmount_Ch'].setValue(false);
    }
    ...
    if(data.Table8[0].isenable==true)
    {
        ...
        this.MasterSubCorporateUpFormGroup.controls['Monthly_Ch'].setValue(false);
    }
    if(data.Table8[1].isenable==true)
    {
        ...
        this.MasterSubCorporateUpFormGroup.controls['Quarterly_Ch'].setValue(false);
    }
    if(data.Table8[2].isenable==true)
    {
        this.MasterSubCorporateUpFormGroup.controls['Half_Yearly_ChFun'].setValue(true);
        // jquery_1_11_3_min_p(row). prop("checked", true);
    }
    else{
        this.MasterSubCorporateUpFormGroup.controls['Half_Yearly_ChFun'].setValue(false);
    }
    if(data.Table8[3].isenable==true)
    {
        ...
        this.MasterSubCorporateUpFormGroup.controls['Yearly_Ch'].setValue(false);
    }
    if(data.Table8[4].isenable==true)
    {
        ...
        this.MasterSubCorporateUpFormGroup.controls['Presented_Ch'].setValue(false);
    }
    ...
    {
        this.MasterSubCorporateUpFormGroup.controls['To_Ch'].setValue(true);
        // jquery_1_11_3_min_p(row). prop("checked", true);
    }
    else{
        this.MasterSubCorporateUpFormGroup.controls['To_Ch'].setValue(false);
    }
    if(data.Table9[1].isenable==true)
    {
        this.MasterSubCorporateUpFormGroup.controls['UntillCancelled_Ch'].setValue(true);
        // jquery_1_11_3_min_p(row). prop("checked", true);
    }
    else{
        this.MasterSubCorporateUpFormGroup.controls['UntillCancelled_Ch'].setValue(false);
    }
...
if(data.Table13.length>0)
{
          ...
          {
            this.MasterSubCorporateUpFormGroup.controls['NachPresentment'].setValue(true);
            
            //jquery_1_11_3_min_p('#chkPresentment').prop('checked', true);
           }else 
           {
           //jquery_1_11_3_min_p('#chkPresentment').prop('checked', false);
           this.MasterSubCorporateUpFormGroup.controls['NachPresentment'].setValue(false);
           }
      if(data.Table13[i].Customerphnumber==1)
     {
        this.MasterSubCorporateUpFormGroup.controls['IsPhoneNumber'].setValue(true);
      ...
      if(data.Table13[i].Customeremailid==1)
     {
      ...
      this.MasterSubCorporateUpFormGroup.controls['EmailId'].setValue(true);
     }
...
if(data.Table13[i].Physical==1)
{
    this.MasterSubCorporateUpFormGroup.controls['IsPhysicalMandateCh'].setValue(true);
     ...
     {
        this.MasterSubCorporateUpFormGroup.controls['ValidationByCustomer_Ch'].setValue(true);
        
      //jquery_1_11_3_min_p('#chkcustomer').prop('checked', true);
     }
      if(data.Table13[i].ValidateByCooperate==1)
     {
        this.MasterSubCorporateUpFormGroup.controls['ValidationByCorporate_Ch'].setValue(true);
...
else
{
    ...
    this.PhysicalTab=false;
     ...
     {
        this.MasterSubCorporateUpFormGroup.controls['QRCode_Ch'].setValue(true);
     // jquery_1_11_3_min_p('input:radio[name="rdoQRLogo"]').filter('[value="1"]').prop('checked', true);
     }
     if(data.Table13[i].PrintLogo==1)
     {
        this.MasterSubCorporateUpFormGroup.controls['Logo_Ch'].setValue(true);
    ...
    //  }
     ...
     {
        this.MasterSubCorporateUpFormGroup.controls['DebitCardCh'].setValue(true);
     ...
     if(data.Table13[i].Aadhar==1)
     {
      ...
      this.MasterSubCorporateUpFormGroup.controls['AadhaarCardCh'].setValue(true);
     }
     }
      if(data.Table13[i].NetBanking==1)
     {
     ...
     {
        this.MasterSubCorporateUpFormGroup.controls['ChkNetMail'].setValue(true);
      //jquery_1_11_3_min_p('#Chknetmail').prop('checked', true);
     }
     if(data.Table13[i].NetManual==1)
     {
        this.MasterSubCorporateUpFormGroup.controls['ChkNetManual'].setValue(true);
      //jquery_1_11_3_min_p('#Chknetmanual').prop('checked', true);
     }
     if(data.Table13[i].NetSMS==1)
     {
        this.MasterSubCorporateUpFormGroup.controls['ChkNetSMS'].setValue(true);
     ...
     {
        this.MasterSubCorporateUpFormGroup.controls['ChkDebitMail'].setValue(true);
      //jquery_1_11_3_min_p('#Chkdebitmail').prop('checked', true);
     }
     if(data.Table13[i].DebitManual==1)
     {
        this.MasterSubCorporateUpFormGroup.controls['ChkDebitManual'].setValue(true);
      //jquery_1_11_3_min_p('#Chkdebitmanual').prop('checked', true);
     }
     if(data.Table13[i].DebitSMS==1)
     {
        this.MasterSubCorporateUpFormGroup.controls['ChkDebitSMS'].setValue(true);
        ...
        //     {
           // var i=0;
            ...
            if(data.Table10[0].isenable==true)
            {
                ...
                this.MasterSubCorporateUpFormGroup.controls['SB_Ch'].setValue(false);
            }
            if(data.Table10[1].isenable==true)
            {
                ...
                this.MasterSubCorporateUpFormGroup.controls['CA_Ch'].setValue(false);
            }
            if(data.Table10[2].isenable==true)
            {
                ...
                this.MasterSubCorporateUpFormGroup.controls['CC_Ch'].setValue(false);
            }
            if(data.Table10[3].isenable==true)
            {
                ...
                this.MasterSubCorporateUpFormGroup.controls['SB_NRE_Ch'].setValue(false);
            }
            if(data.Table10[4].isenable==true)
            {
                ...
                this.MasterSubCorporateUpFormGroup.controls['SB_NRO_Ch'].setValue(false);
            }
            if(data.Table10[5].isenable==true)
            {
                ...
                this.MasterSubCorporateUpFormGroup.controls['Other_Ch'].setValue(false);
            }
...
var categorycode = [];
            ...
            // this.MasterSubCorporateUpFormGroup.controls['categorycodeid'].setValue(data.Table14.data.Table15[0].categoryId);
            //this.MasterSubCorporateUpFormGroup.controls['categorycodeidNach'].setValue(data.Table14[0].categoryId);
        ...
        // kendo_all_min_js("#txtEntityBusinessCode").data("kendoDropDownList").value(jsonData[i].categoryId);
                this.MasterSubCorporateUpFormGroup.controls['categorycodeid'].setValue(data.Table15[0].categoryId);
            }
            ...
            this.MasterSubCorporateUpFormGroup.controls['PAN'].setValue(data.Table16[i].PAN_No);
           // jquery_1_11_3_min_p('#txttan').val(data.Table16.TAN_No);
            this.MasterSubCorporateUpFormGroup.controls['TAN'].setValue(data.Table16[i].TAN_No);
            //jquery_1_11_3_min_p('#txtgstin').val(data.Table16.GSTIN_No);
            this.MasterSubCorporateUpFormGroup.controls['GST'].setValue(data.Table16[i].GSTIN_No);
            //jquery_1_11_3_min_p('#txtbillingaddress').val(data.Table16.BillingAddress);
            this.MasterSubCorporateUpFormGroup.controls['BillingAddress'].setValue(data.Table16[i].BillingAddress);
            //jquery_1_11_3_min_p('#txtdebitaccno').val(data.Table16.ChargeDebitAcNo);
            this.MasterSubCorporateUpFormGroup.controls['BillingChargeDebitAccNo'].setValue(data.Table16[i].ChargeDebitAcNo);
            //jquery_1_11_3_min_p('#txtcorpid').val(data.Table16.BankCorporateId);
            this.MasterSubCorporateUpFormGroup.controls['BillingBankCorpId'].setValue(data.Table16[i].BankCorporateId);
            //jquery_1_11_3_min_p('#txtbranchname').val(data.Table16.BranchName);
            this.MasterSubCorporateUpFormGroup.controls['BillingBranchName'].setValue(data.Table16[i].BranchName);
            //jquery_1_11_3_min_p('#txtbranchcode').val(data.Table16.BranchCode);
            this.MasterSubCorporateUpFormGroup.controls['BillingBranchCode'].setValue(data.Table16[i].BranchCode);
           // jquery_1_11_3_min_p('#txtbranchifsc').val(data.Table16.IFSC);
            this.MasterSubCorporateUpFormGroup.controls['BillingIFSC'].setValue(data.Table16[i].IFSC);
            //jquery_1_11_3_min_p('#txtbillingcontactperson').val(data.Table16.BillingContactPerson);
            this.MasterSubCorporateUpFormGroup.controls['BillContractPerson'].setValue(data.Table16[i].BillingContactPerson);
            //jquery_1_11_3_min_p('#txtdesignation').val(data.Table16.Designation);
            this.MasterSubCorporateUpFormGroup.controls['Designation'].setValue(data.Table16[i].Designation);
           // jquery_1_11_3_min_p('#txtcontactno').val(data.Table16.ContactNo);
            this.MasterSubCorporateUpFormGroup.controls['BillingContactNo'].setValue(data.Table16[i].ContactNo);
           // jquery_1_11_3_min_p('#txtfaxno').val(data.Table16.FaxNo);
            this.MasterSubCorporateUpFormGroup.controls['BillFaxNo'].setValue(data.Table16[i].FaxNo);
            if(data.Table16[i].ArrangementInDays==0)
            {
                this.MasterSubCorporateUpFormGroup.controls['Arrangementdays'].setValue(0);
            }
            else
            {
           // jquery_1_11_3_min_p('#ddlarrangementdays').val(data.Table16.ArrangementInDays);
           this.MasterSubCorporateUpFormGroup.controls['Arrangementdays'].setValue(data.Table16[i].ArrangementInDays);
            }
           // jquery_1_11_3_min_p('#txtpickupaddr').val(data.Table16.PickUpLocationAddress);
            this.MasterSubCorporateUpFormGroup.controls['BillingPicupLocationAddress'].setValue(data.Table16[i].PickUpLocationAddress);
            //jquery_1_11_3_min_p('#txtpickupcontactperson').val(data.Table16.PickUpContactPerson);
            this.MasterSubCorporateUpFormGroup.controls['BillingPicupContactPerson'].setValue(data.Table16[i].PickUpContactPerson);
            //jquery_1_11_3_min_p('#txtmailprimary').val(data.Table16.CommunicationMailPrimary);
            this.MasterSubCorporateUpFormGroup.controls['BillingCommunicationMailPrimary'].setValue(data.Table16[i].CommunicationMailPrimary);
            // this.MasterSubCorporateUpFormGroup.controls['BillingCommunicationMailBilling'].setValue(data.Table16[i].CommunicationMailPrimary);
            //kendo_all_min_js("#ddlpsm").data("kendoDropDownList").text(data.Table16.PSM_Name);
        // this.MasterSubCorporateUpFormGroup.controls['PSMId'].setValue(data.Table16[i].PSM_Name);
            //kendo_all_min_js("#ddlregionalmgr").data("kendoDropDownList").text(data.Table16.RM_Name);
            this.MasterSubCorporateUpFormGroup.controls['PSMId'].patchValue({PSM_Name : data.Table16[i].PSM_Name})
           this.MasterSubCorporateUpFormGroup.controls['RMId'].setValue(data.Table16[i].RM_Name);
          // this.MasterSubCorporateUpFormGroup.controls['RMId'].patchValue({RM_Name : data.Table16[i].RM_Name})
           // kendo_all_min_js("#ddlsettlementtype").data("kendoDropDownList").text(data.Table16.SettlementType);
            this.MasterSubCorporateUpFormGroup.controls['SettlementTypeId'].setValue(data.Table16[i].SettlementType);
           //this.MasterSubCorporateUpFormGroup.controls['SettlementTypeId'].patchValue({SettlementType : data.Table16[i].SettlementType})
            // kendo_all_min_js("#ddlbusinesssegment").data("kendoDropDownList").text(data.Table16.BusinessSegmentName);
             this.MasterSubCorporateUpFormGroup.controls['BusinessSegmentId'].setValue(data.Table16[i].BusinessSegmentName);
            // this.MasterSubCorporateUpFormGroup.controls['BusinessSegmentId'].patchValue({BusinessSegmentName : data.Table16[i].BusinessSegmentName})
            }
            ...
            if(data.Table17[i].Ip!="" || data.Table17[i].Url!="" || data.Table17[i].UserName !="" || data.Table17[i].Password !="")
            {
               ...
               this.MasterSubCorporateUpFormGroup.controls['IsRequired'].setValue(true);
               
                ////jquery_1_11_3_min_p('#txtip').val(jsonData[i].Ip);
                this.MasterSubCorporateUpFormGroup.controls['BillingIP'].setValue(data.Table17[i].Ip);
               // jquery_1_11_3_min_p('#txturl').val(jsonData[i].Url);
               this.MasterSubCorporateUpFormGroup.controls['BillingURL'].setValue(data.Table17[i].Url);
               // jquery_1_11_3_min_p('#txtuser').val(jsonData[i].UserName);
               this.MasterSubCorporateUpFormGroup.controls['BillingUserName'].setValue(data.Table17[i].UserName);
               // jquery_1_11_3_min_p('#txth2hpassword').val(jsonData[i].Password);
               this.MasterSubCorporateUpFormGroup.controls['BillingPassword'].setValue(data.Table17[i].Password);
...
// }
            ...
            // this.MasterSubCorporateUpFormGroup.controls['Code'].setValue(data.Code);
            // this.MasterSubCorporateUpFormGroup.controls['EntityName'].setValue(data.EntityName);
            // this.MasterSubCorporateUpFormGroup.controls['PhoneNo'].setValue(data.PhoneNo);
            // this.MasterSubCorporateUpFormGroup.controls['EmailID'].setValue(data.EmailId);
            // this.MasterSubCorporateUpFormGroup.controls['DesignationId'].setValue(data.DesignationId);
            // this.MasterSubCorporateUpFormGroup.controls['IsActive'].setValue((data.IsActive == 'Active' ? true:false));
        });
...
get AllFields() { return this.MasterSubCorporateUpFormGroup.controls; }
...
isFieldValid(field: string) {
    return !this.MasterSubCorporateUpFormGroup.get(field).valid && this.MasterSubCorporateUpFormGroup.get(field).touched;
}
...
SaveFun() {
    ...
    debugger;
    if(this.MasterSubCorporateUpFormGroup.valid)
    {
        this.allFieldOfForm = this.MasterSubCorporateUpFormGroup.value;
        ...
        //const data = this.MasterSubCorporateUpFormGroup.value;
        ...
        this.validateAllFormFields(this.MasterSubCorporateUpFormGroup);
    }
}
