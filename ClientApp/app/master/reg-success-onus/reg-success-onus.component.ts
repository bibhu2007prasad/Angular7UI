...
@Component({
  selector: 'app-reg-success-onus',
  templateUrl: './reg-success-onus.component.html',
  styleUrls: ['./reg-success-onus.component.css']
})
export class RegSuccessOnusComponent implements OnInit {
