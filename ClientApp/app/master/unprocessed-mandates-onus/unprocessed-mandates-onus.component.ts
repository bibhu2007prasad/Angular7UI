...
import { UnderProcessMandateInWard } from '../../Models/UnderProcessMandateInWard/underProcessMandateInWard';
import { CorporateUnInWord } from '../../Models/UnderProcessMandateInWard/corporateUnInWord';
import { SponserBankUnInWord } from '../../Models/UnderProcessMandateInWard/sponserBankInWord';
import { DownloadOldMandateUnProcessInWordService } from '../../Services/download-old-mandate-un-process-in-word.service';
...
@Component({
  selector: 'app-unprocessed-mandates-onus',
  templateUrl: './unprocessed-mandates-onus.component.html',
  styleUrls: ['./unprocessed-mandates-onus.component.css']
})
export class UnprocessedMandatesOnusComponent implements OnInit {

  UnderProcessMandateForm: FormGroup; HeaderArray;corporate:CorporateUnInWord; sponserBank:SponserBankUnInWord;
  BindAllData: UnderProcessMandateInWard; TotalCount = 0; dataArray: Array<UnderProcessMandateInWard> = [];
  ...
  SponserBankCode: any;
  length: any;
  ZipDownloadArray: Array<UnderProcessMandateInWard> = [];
  constructor(public myservice: DownloadOldMandateUnProcessInWordService, private formBuilder: FormBuilder) { 
    this.corporate = new CorporateUnInWord();
      this.corporate.dataList = [];

      this.sponserBank = new SponserBankUnInWord();
      this.sponserBank.dataList = [];

      this.BindAllData = new UnderProcessMandateInWard();
