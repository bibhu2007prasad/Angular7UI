...
import { HistoricalMandateClass } from '../../Models/MandateRegOutWordHistoricalMandate/historicalMandateClass';
import { Corporate } from '../../Models/MandateRegOutWordHistoricalMandate/Corporate/corporate';

import { HitoricalMandateService } from 'ClientApp/app/Services/hitorical-mandate.service';
import { UrlSegment } from '@angular/router';
import { Observable } from 'rxjs';
import { HttpClient, HttpHeaders } from '@angular/common/http';

@Component({
  selector: 'app-newhistoricalmandate',
  templateUrl: './newhistoricalmandate.component.html',
  styleUrls: ['./newhistoricalmandate.component.css']
})
export class NewhistoricalmandateComponent implements OnInit {

  HistoricalMandateForm: FormGroup; HeaderArray;corporate:Corporate;
  ...
  constructor(private HMService: HitoricalMandateService, private formBuilder: FormBuilder) {
  ...
  SearchFunction(FromDate, ToDate) {
    ...
    const datat = this.HistoricalMandateForm.value;
      this.Preloader = true;
